    ...
    const fetchGeneData = async () => {
      try {
        ...
        const response = await fetch(
          `http://127.0.0.1:8000/data/api/annotation/?gene_instance=${gene}`,
          {
            headers: {
        ...
        setFormData({
          ...
          gene_biotype:
            geneData.gene_biotype === "No gene biotype provided."
              ? ""
              : geneData.gene_biotype,
          transcript_biotype:
            geneData.transcript_biotype === "No transcript biotype provided."
              ? ""
              : geneData.transcript_biotype,
          gene_symbol:
            geneData.gene_symbol === "No gene symbol provided."
              ? ""
              : geneData.gene_symbol,
          description:
            geneData.description === "No description provided."
              ? ""
  ...
  const renderGeneDetails = () => (
    <div className="space-y-6 rounded-xl bg-white dark:bg-gray-800/80 p-8 border border-slate-200/60 dark:border-gray-700/60 shadow-lg">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <FormField label="Gene" name="gene" tooltip="Gene identifier">
          <Input
            id="gene"
            name="gene"
            value={formData.gene}
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        >
          <Select
            ...
            onValueChange={(value) =>
              handleInputChange({
                target: { name: "transcript_biotype", value },
              })
            }
          >
            <SelectTrigger className="border-slate-200 dark:border-gray-700 focus:ring-2 focus:ring-indigo-500 transition-all">
            ...
            <SelectContent>
              <SelectItem value="protein_coding">Protein Coding</SelectItem>
              <SelectItem value="processed_transcript">
                Processed Transcript
              </SelectItem>
              <SelectItem value="nonsense_mediated_decay">
        ...
        >
          <Select
            ...
            onValueChange={(value) =>
              handleInputChange({
                target: { name: "strand", value: parseInt(value) },
              })
            }
          >
            <SelectTrigger className="border-slate-200 dark:border-gray-700 focus:ring-2 focus:ring-indigo-500 transition-all">
